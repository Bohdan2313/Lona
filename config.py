...
# config.py
DESIRED_ACTIVE_TRADES = 8             # скільки ХОЧЕМО одночасних угод
...
MANUAL_BALANCE = 20.0  # $ старт на угоду (маржа першої сходинки)
...
SMART_AVG = {
    ...
    "leverage": 5,
    "base_margin": 20,          # стартова маржа на угоду (1-а сходинка)

    "max_adds": 10,                 # кількість докупок максимум
    ...
    "tp_from_avg_pct": 0.006,
    "alt_tp_from_avg_pct": 0.006,
